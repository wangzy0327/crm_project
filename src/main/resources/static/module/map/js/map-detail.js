...
module.data = {
    ...
    message_obj: {
        id: YT.getUrlParam('id'),
        name: YT.getUrlParam('name')
    }
};
...
module.service = {
    ...
    getChartMap: function () {
        var self = this, module_d = module.data, chart_panel = module_d.chart_panel, message_obj = module_d.message_obj;

        var filter = [
            {field: 'messageId', value: message_obj.id, operator: '=', relation: 'and'}
        ];
    ...
    setChartSize: function () {
        var myCharts = module.data.myCharts, doc_h = document.body.clientHeight, height_panel = doc_h - 30;
