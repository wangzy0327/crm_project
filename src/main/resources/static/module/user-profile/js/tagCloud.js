...
TagCould.prototype.doPosition = function(){
    ...
    for(var i=0; i < this.mcList.length; i++){
        ...
        this.aA[i].style.top = this.mcList[i].cy + t - this.mcList[i].offsetHeight / 3+'px';

        this.aA[i].style.fontSize = Math.ceil(12 * this.mcList[i].scale / 2) + 15+ parseInt((this.aA[i].dataset.weight>5) ? 5 : this.aA[i].dataset.weight)*4 + 'px';
