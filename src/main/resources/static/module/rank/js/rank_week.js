...
module.service = {
    ...
    initList: function () {
        var data = {
            m: 1050000,
            t: 'v_staffs_groups',
            params: JSON.stringify({groupid:YT.getUrlParam('groupid'),ticket: module.data.ticket, rank_category: 2})
        };
        YT.query({
            data: data,
            successCallback: function (data) {
                if (200 == data.status) {
                    ...
                    $('#week_list_items').html(str);
                } else {
                    $('#week_list_items').text(data.message);
                }
            }
        });
    }
