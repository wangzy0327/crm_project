...
public class BooleanPref extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        JDBCDataModel dataModel = new MySQLBooleanPrefJDBCDataModel(dataSource,"v_customer_transmit","customer_id","message_id","update_time");
...
//            Statement stmt = con.createStatement();
            ...
            while (iter.hasNext()) {
                ...
                for (RecommendedItem recommendedation : recommendations) {
                    ...
                    ReadTransmitRecommend readTransmitRecommend = new ReadTransmitRecommend();
                    readTransmitRecommend.setCustomerId(Long.valueOf(uid).intValue());
                    readTransmitRecommend.setMessageId(Long.valueOf(recommendedation.getItemID()).intValue());
                    readTransmitRecommend.setValue(Float.valueOf(recommendedation.getValue()).doubleValue());
                    readTransmitRecommendMapper.insert(readTransmitRecommend);
                }
            }
        ...
        System.out.println("BooleanPref----" + sdf.format(new Date()));
    }
}
